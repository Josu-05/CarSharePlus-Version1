...
namespace CarSharePlus.Shared.Models
{
    ...
    { 
        ...
        public EstadoReserva Estado { get; set; } = EstadoReserva.Pendiente; public 
        ...
        public static ValidationResult ValidarFechas(DateTime fechaFin, ValidationContext context) { var instance = context.ObjectInstance as Reserva; 
